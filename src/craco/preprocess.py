...
class FastPreprocess:
    ...
    def log_flagging_stats(self):
        ...
        out_str = f"{self.num_nblks:g}\t{good_bls_pre:.2f}\t{good_cells_pre:.2f}\t{good_bls_post:.2f}\t{good_cells_post:.2f}\t{bad_cells_pre:.2f}\t{bad_cells_post:.2f}\t{self.blk_shape}\t{self.total_num_cells:.2f}\t{self.num_fixed_good_chans:g}\n"
