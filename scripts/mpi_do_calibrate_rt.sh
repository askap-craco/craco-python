...
export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/CRACO/SOFTWARE/craco/craftop/lib/calib
...
cmd="/CRACO/SOFTWARE/craco/craftop/softwares/craco_calib/calib_skadi.py -uv $uvfits"
echo running $cmd
$cmd 
