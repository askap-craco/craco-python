...
The simplest way to install craco-python is using Pip.

.. code-block:: console

    $ pip install craco

This will install ``craco`` and all of its dependencies.
...
Report bugs at the `issue tracker <https://github.com/strocode/craco/issues>`_.
